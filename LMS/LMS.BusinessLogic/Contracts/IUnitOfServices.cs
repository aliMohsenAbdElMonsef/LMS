...
namespace LMS.BusinessLogic.Contracts
{
    public interface IUnitOfServices
    {
        ...
        IStudentEnrollment StudentEnrollIntoCourse { get; }
        IEnrollmentManagement EnrollmentManagement { get; }

        IInstructorEnrollIntoCourse InstructorEnrollIntoCourse { get; }
    }
}
