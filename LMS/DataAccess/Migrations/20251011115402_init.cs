        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Skills_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CertificateTemplateID = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificateTemplates_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRecordingUploadDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CourseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AssignedInstructorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    LastUploadedByInstructorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_AspNetUsers_AssignedInstructorId",
                        column: x => x.AssignedInstructorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Lectures_AspNetUsers_LastUploadedByInstructorId",
                        column: x => x.LastUploadedByInstructorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    certificateTamplateId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Id = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GeneratedPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IssuedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCertificates", x => new { x.StudentId, x.certificateTamplateId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.certificateTamplateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAnswers", x => new { x.StudentId, x.QuestionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateTemplates_AdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lectures_AssignedInstructorId",
                table: "Lectures",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lectures_LastUploadedByInstructorId",
                table: "Lectures",
                column: "LastUploadedByInstructorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCertificates_certificateTamplateId",
